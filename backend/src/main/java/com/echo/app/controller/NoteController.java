...
public class NoteController {
    ...
    public ResponseEntity<PagedResponse<NoteResponse>> listNotes(
        ...
        PagedResponse<NoteResponse> response = noteService.getNotes(page, size, sortField, sortDirection);
    ...
    public ResponseEntity<NoteResponse> createNote(
            @Valid @RequestBody CreateNoteRequest request, HttpServletRequest httpRequest) {

        String clientIp = getClientIp(httpRequest);
        String userAgent = httpRequest.getHeader("User-Agent");

        NoteResponse response = noteService.createNote(request, clientIp, userAgent);
